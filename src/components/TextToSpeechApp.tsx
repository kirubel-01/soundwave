              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <Button 
                    ...
                    className="w-full sm:w-auto min-w-[140px] bg-primary hover:bg-primary/90 text-white shadow-md hover:shadow-lg transition-all"
                  >
                    {isLoading ? (
                      <>
          ...
          <TabsContent value="history" className="mt-6 animate-scale-in">
            {history.length > 0 ? (
              <div className="space-y-4">
                {history.map((item) => (
                  <HistoryItem key={item.id} item={item} onReplay={handleReplay} />
                ))}
              </div>
            ) : (
